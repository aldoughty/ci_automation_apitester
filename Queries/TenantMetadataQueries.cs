namespace ci_automation_apitester.Queries
{
    ...
    {
        internal static string QueryAllTenants(string env)
        {
        ...
        internal static string QueryAllTenantRoles(string env)
        {
        ...
        internal static string QueryAllTenantKeysHavingTenantRoles(string env)
        {
        ...
        internal static string QueryAllTenantKeysNotHavingTenantRoles(string env)
        {
        ...
        internal static string QueryTenantRolesByTenantId(string tenantId, string env)
        {
        ...
        internal static string QueryAllTenantOrgs(string env)
        {
