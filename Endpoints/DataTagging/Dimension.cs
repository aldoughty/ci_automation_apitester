...
{
    public class Dimension : BaseRestApi
    {
        const string Url = "/tagging/api/Dimension";
        ...
        public override List<TestStep> GetParameterTests(MessageData messageData, string authValue, IEnvironment environment)
        {
            ...
            //Returns all Dimensions in taggingUI.Dimension (for GET All Dimension)
            DataTable dataTable = DataBaseExecuter.ExecuteCommand("SQL", SecretsManager.SQLConnectionString(), query.QueryDimensions());
